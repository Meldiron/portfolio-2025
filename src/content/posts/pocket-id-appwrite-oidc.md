---
title: "Passkey authentication in any app with Pocket ID and Appwrite"
pubDate: 2026-05-03 #Y-M-D
...
image: { url: "/posts/pocket-id-appwrite-oidc/appwite-pocket-id-thumbnail.png", alt: "Pocket ID with Appwrite" }
highlight: false
---
...
![Appwrite OIDC Settings](/posts/pocket-id-appwrite-oidc/appwrite-oidc-settings.png)
...
2. Click **[Deploy on Railway](https://railway.com/deploy/u-A3IE?referralCode=Y3OU6o)** to open the Pocket ID template.
...
![Railway Pocket ID Template](/posts/pocket-id-appwrite-oidc/railway-pocket-id-template.png)
...
![Railway Setup complete](/posts/pocket-id-appwrite-oidc/railway-setup-complete.png)
...
![Pocket ID Onboarding](/posts/pocket-id-appwrite-oidc/pocket-id-onboarding.png)
...
![Pocket ID Passkey](/posts/pocket-id-appwrite-oidc/pocket-id-passkey.png)
...
![Pocket ID OIDC Client](/posts/pocket-id-appwrite-oidc/pocket-id-oidc-client.png)
...
Now let's wire everything together in a small frontend. We'll use [Astro](https://astro.build) because it's minimal and ships zero JavaScript by default, making it easy to follow-along. The full source code is available at [github.com/Meldiron/pocket-id-demo](https://github.com/Meldiron/pocket-id-demo).
...
Open `src/pages/index.astro`. We'll add [Launch CSS](https://get.foundation/sites/docs/) for minimal styling. Add the following `<link>` inside the `<head>`:
...
![Demo app sign-in](/posts/pocket-id-appwrite-oidc/demo-app-sign-in.png)
...
![Demo app consent screen](/posts/pocket-id-appwrite-oidc/demo-app-consent-screen.png)
...
![Demo app dashboard](/posts/pocket-id-appwrite-oidc/demo-app-dashboard.png)
...
The local demo works, now let's put it on the internet. [Appwrite Sites](https://appwrite.io/products/sites) is a free hosting platform built into Appwrite that serves static sites from a global CDN, so your Astro app is a natural fit.
...
5. Click **Deploy** and watch the build logs.
...
- **OIDC deep dive**: Learn more about how the OpenID Connect protocol works in the [Understanding OAuth and OpenID Connect](https://appwrite.io/blog/post/oauth-openid) article.
